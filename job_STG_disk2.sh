#!/bin/sh
#BSUB -q c02516
#BSUB -J rStar_Project_STG_disk2
#BSUB -n 4
...
#BSUB -M 16GB
#BSUB -W 12:00
#BSUB -o rStar_Output_rStar_Project_STG_disk2_%J.out
#BSUB -e rStar_Error_rStar_Project_STG_disk2_%J.err
...
bash /zhome/d6/a/186925/Deep_Learning/rStar/scripts/run_STG_generator_disk2.sh --gpu_memory_utilization 0.9